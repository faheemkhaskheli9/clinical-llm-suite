"""One-off local check: confirm the 3 source repos are actually archived.
...
`clinical-llm-suite`). The reusable detection logic this exercises is
...
from clinical_core.archival import check_archival  # noqa: E402
